...
const result = UniFFIScaffolding.callSync(
    121, // uniffi_relevancy_fn_func_score
...
export class RelevancyStore extends RelevancyStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            122, // uniffi_relevancy_fn_constructor_relevancystore_new
    ...
    async banditInit(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            123, // uniffi_relevancy_fn_method_relevancystore_bandit_init
    ...
    async banditSelect(
        ...
        FfiConverterSequenceString.checkType(arms);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            124, // uniffi_relevancy_fn_method_relevancystore_bandit_select
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
            FfiConverterSequenceString.lower(arms),
        )
    ...
    async banditUpdate(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            125, // uniffi_relevancy_fn_method_relevancystore_bandit_update
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
    ...
    close() {
        ...
        const result = UniFFIScaffolding.callSync(
            126, // uniffi_relevancy_fn_method_relevancystore_close
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async ensureInterestDataPopulated() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            127, // uniffi_relevancy_fn_method_relevancystore_ensure_interest_data_populated
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getBanditData(
        ...
        FfiConverterString.checkType(arm);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            128, // uniffi_relevancy_fn_method_relevancystore_get_bandit_data
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
            FfiConverterString.lower(arm),
        )
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            129, // uniffi_relevancy_fn_method_relevancystore_ingest
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
    ...
    interrupt() {
        ...
        const result = UniFFIScaffolding.callSync(
            130, // uniffi_relevancy_fn_method_relevancystore_interrupt
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async userInterestVector() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            131, // uniffi_relevancy_fn_method_relevancystore_user_interest_vector
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
